...
function hasExpressions(json) { try { const b = JSON.stringify(json); return b.indexOf('"ef":[{') >= 0 || b.indexOf('"x":"') >= 0 } catch { return true } }   // '"ef":[{' = efectos NO vacios (antes '"ef":' rechazaba '"ef":[]' vacio = falso positivo)
