...
// tintHue: lleva el HUE de un hex hacia un anchor con peso w (preserva S/L del que lo llama). PURO. ESPEJO de src/urvid (grade-to-palette).
...
function P(id, category, render, meta = {}) {
  register({ id, lib: 'post', category, tones: meta.tones || ['dark', 'light'], rubros: meta.rubros || ['*'], weight: meta.weight || 1, tags: meta.tags || [], render })
}
...
}, { tags: ['grano', 'film', 'textura'], weight: 1.1 })
...
}, { tags: ['grano', 'fino', 'sutil'], weight: 0.9 })
...
}, { tags: ['vignette', 'foco', 'cine'], weight: 1.2 })
...
}, { tags: ['vignette', 'marco', 'letterbox'], weight: 0.9 })
...
}, { tags: ['leak', 'calido', 'analogico'], weight: 0.8, tones: ['dark'] })
...
}, { tags: ['leak', 'acento', 'prisma'], weight: 0.8, tones: ['dark'] })
...
}, { tags: ['bloom', 'halacion', 'glow'], weight: 0.85 })
...
}, { tags: ['scanlines', 'crt', 'retro'], weight: 0.7, rubros: ['*', 'tech', 'gaming', 'eventos', 'musica'] })
...
}, { tags: ['crt', 'retro', 'tv'], weight: 0.6, rubros: ['*', 'tech', 'gaming', 'musica'] })

// ---- grade (tinte global LEVE; preserva contraste -> alpha bajo + overlay) ----
P('post.grade.warm', 'grade', (ctx, t, env) => {
  const hw = tintHue(env.pal.accent, 30, 0.7)   // hue del acento empujado a CALIDO; S/L pin de #ffb070/#7a4a2a (grade-to-palette)
...
}, { tags: ['grade', 'calido', 'dorado'], weight: 1, rubros: ['*', 'gastronomia', 'moda', 'belleza', 'inmobiliaria'] })

P('post.grade.cool', 'grade', (ctx, t, env) => {
  const hc = tintHue(env.pal.accent, 210, 0.7)   // hue del acento empujado a FRIO; S/L pin de #7fd0ff/#243a6a (grade-to-palette)
...
}, { tags: ['grade', 'frio', 'clinico'], weight: 1, rubros: ['*', 'tech', 'finanzas', 'salud'] })
...
}, { tags: ['grade', 'fade', 'analogico', 'suave'], weight: 0.9 })
...
}, { tags: ['dust', 'motas', 'analogico'], weight: 0.6 })
