...
register({
  ...
  derive(brandColor, { tone }) {
    ...
    const accent = safeAccent(hslToHex(h, clamp(a.s + 0.05, 0.55, 0.92), tone === 'light' ? 0.5 : 0.62), tone)
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 38, 0.92), clamp(a.s + 0.08, 0.6, 0.95), 0.6), 'dark')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 44, 0.88), clamp(a.s, 0.45, 0.82), 0.63), 'dark')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 36, 0.92), clamp(a.s + 0.1, 0.65, 0.98), 0.6), 'dark')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 14, 0.92), clamp(a.s + 0.12, 0.7, 1), 0.56), 'dark')   // brasa naranja-rojo
...
register({
  ...
  derive(brandColor, { tone, seed }) {
    ...
    const accent = safeAccent(hslToHex(pushHue(a.h, warm, 0.9), clamp(a.s + 0.06, 0.6, 0.95), tone === 'light' ? 0.5 : 0.62), tone)
...
register({
  ...
  derive(brandColor, { tone }) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 42, 0.88), clamp(a.s + 0.12, 0.7, 1), tone === 'light' ? 0.48 : 0.62), tone)
...
register({
  ...
  derive(brandColor, { tone }) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 18, 0.9), clamp(a.s, 0.5, 0.85), tone === 'light' ? 0.46 : 0.58), tone)  // terracota
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 34, 0.9), clamp(a.s, 0.5, 0.85), 0.46), 'light')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 214, 0.9), clamp(a.s + 0.05, 0.5, 0.9), 0.62), 'dark')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 212, 0.85), clamp(a.s, 0.35, 0.7), 0.68), 'dark')   // plateado-azul, suave
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 190, 0.9), clamp(a.s, 0.45, 0.85), 0.6), 'dark')   // teal frio
...
register({
  ...
  derive(brandColor, { tone }) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 205, 0.9), clamp(a.s, 0.45, 0.85), tone === 'light' ? 0.46 : 0.62), tone)
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 202, 0.9), clamp(a.s, 0.5, 0.88), 0.46), 'light')
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 194, 0.9), clamp(a.s, 0.5, 0.9), 0.44), 'light')   // cyan-hielo
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 218, 0.85), clamp(a.s * 0.85, 0.35, 0.7), 0.46), 'light')   // apagado, gris-azul
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 176, 0.9), clamp(a.s, 0.45, 0.85), 0.42), 'light')   // menta-glaciar
...
register({
  ...
  derive(brandColor) {
    const a = hexToHsl(brandColor || '#5b8cff')
    const accent = safeAccent(hslToHex(pushHue(a.h, 206, 0.92), clamp(a.s + 0.08, 0.6, 0.95), 0.62), 'dark')   // azul electrico
