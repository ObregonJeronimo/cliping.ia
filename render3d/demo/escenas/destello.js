...
export function build(ctx) {
  ...
  tl.to(pelicula.uFlash, { value: 0, duration: 3 * F, ease: E.acelera(2) }, F)
  ...
  tl.to(pelicula.uAberr, { value: 0.0020, duration: b(0.6), ease: E.frena(2) }, F)
  ...
  tl.fromTo([mArriba.userData.u.uProg, mAbajo.userData.u.uProg], { value: 0 },
    { value: ABIERTO, duration: b(0.42), ease: E.frena(4), stagger: 0.035 }, b(0.10))
  tl.fromTo(heroWrap.position, { x: -0.16 }, { x: 0, duration: b(0.55), ease: E.llega(2.2) }, b(0.10))
  tl.fromTo(heroWrap.scale, { x: 1.10 }, { x: 1, duration: b(0.50), ease: E.llega(1.9) }, b(0.10))

  tl.fromTo(vRegla.scale, { y: 0.0001 }, { y: 1, duration: b(0.42), ease: E.llega(1.7) }, b(0.22))

  tl.fromTo(L1.userData.u.uProg, { value: 0 }, { value: ABIERTO, duration: b(0.34), ease: E.frena(4) }, b(0.28))
  tl.fromTo(L1.position, { x: -0.10 }, { x: 0, duration: b(0.42), ease: E.llega(2.4) }, b(0.28))

  tl.fromTo(arcoTop.scale, { x: 0.0001, y: 0.0001 }, { x: 1, y: 1, duration: b(0.60), ease: E.llega(2.4) }, b(0.40))
  tl.fromTo(arcoTop.rotation, { z: -0.95 }, { z: 0, duration: b(0.70), ease: E.frena(3) }, b(0.40))
  ...
  tl.fromTo(barras.map(m => m.scale), { x: 0.0001 },
    { x: 1, duration: b(0.34), ease: E.llega(1.7), stagger: 0.055 }, b(0.80))

  tl.fromTo(etiqueta.userData.u.uProg, { value: 0 }, { value: ABIERTO, duration: b(0.28), ease: E.frena(3) }, b(0.95))
  tl.fromTo(regla.scale, { x: 0.0001 }, { x: 1, duration: b(0.40), ease: E.frena(5) }, b(0.95))
  tl.fromTo(caption.userData.u.uProg, { value: 0 }, { value: ABIERTO, duration: b(0.32), ease: E.frena(3) }, b(1.05))
  tl.fromTo(puntos.map(m => m.scale), { x: 0.0001 },
    { x: 1, duration: b(0.20), ease: E.llega(3), stagger: 0.038 }, b(1.12))
  tl.fromTo(cuadrito.scale, { x: 0.0001, y: 0.0001 }, { x: 1, y: 1, duration: b(0.26), ease: E.llega(3) }, b(1.20))
  ...
  tl.to(disco.position, { y: 2.78, duration: b(2.0), ease: E.vaiven() }, b(1.30))
  ...
  tl.fromTo(heroG.scale, { x: 1, y: 1 }, { x: 1.028, y: 1.028, duration: b(0.12), ease: E.frena(2) }, b(1.00))
  tl.to(heroG.scale, { x: 1, y: 1, duration: b(0.22), ease: E.vaiven(2) }, b(1.12))
  tl.to(heroG.scale, { x: 1.028, y: 1.028, duration: b(0.12), ease: E.frena(2) }, b(1.50))
  tl.to(heroG.scale, { x: 1, y: 1, duration: b(0.22), ease: E.vaiven(2) }, b(1.62))
  tl.to(regla.scale, { x: 0.62, duration: b(0.10), ease: E.acelera(3) }, b(1.75))
  tl.to(regla.scale, { x: 1, duration: b(0.20), ease: E.llega(2.6) }, b(1.85))
  ...
  tl.to(pelicula.uFlash, { value: 0, duration: F, ease: E.acelera(2) }, b(2.00) + F)
  tl.to(pelicula.uAberr, { value: 0.0065, duration: F, ease: 'none' }, b(2.00))
  tl.to(pelicula.uAberr, { value: 0.0020, duration: b(0.5), ease: E.frena(2) }, b(2.00) + F)

  tl.fromTo(mArriba.position, { y: mArriba.userData.y0, x: 0 },
    { y: mArriba.userData.y0 + 0.42, x: 0.15, duration: b(0.32), ease: E.llega(2.6) }, b(2.00))
  tl.fromTo(mAbajo.position, { y: mAbajo.userData.y0, x: 0 },
    { y: mAbajo.userData.y0 - 0.42, x: -0.15, duration: b(0.32), ease: E.llega(2.6) }, b(2.03))
  tl.fromTo(lineaAcento.scale, { x: 0.0001 }, { x: 1, duration: b(0.34), ease: E.frena(5) }, b(2.02))
  ...
  tl.to(heroWrap.scale, { x: 2.40, y: 2.40, duration: b(0.60), ease: E.acelera(3) }, b(2.72))
  tl.to(mArriba.position, { y: mArriba.userData.y0 + 0.95, duration: b(0.55), ease: E.acelera(2) }, b(2.72))
  tl.to(mAbajo.position, { y: mAbajo.userData.y0 - 0.95, duration: b(0.55), ease: E.acelera(2) }, b(2.72))
  tl.to([mArriba.userData.u.uProg, mAbajo.userData.u.uProg],
    { value: 0.04, duration: b(0.50), ease: E.acelera(2), stagger: 0.03 }, b(2.80))
  tl.to(formas.scale, { x: 1.9, y: 1.9, duration: b(0.55), ease: E.acelera(3) }, b(2.74))
  tl.to(lineaAcento.scale, { x: 1.6, y: 4.0, duration: b(0.42), ease: E.acelera(3) }, b(2.80))
  ...
  tl.to(pelicula.uFlash, { value: 0, duration: 3 * F, ease: E.acelera(2) }, b(3.50) + F)
  ...
  tl.to(fondo.uGrilla, { value: oGrilla, duration: b(0.40), ease: E.frena(2) }, b(3.50) + F)
  ...
  tl.fromTo(fondo.uPulso, { value: oPulso }, { value: 0.30, duration: b(0.10), ease: E.frena(2) }, b(3.52))
  tl.to(fondo.uPulso, { value: oPulso, duration: b(0.30), ease: E.acelera(2) }, b(3.62))

  // El panel se retira hacia abajo y destapa el fondo oscuro desde arriba, con su filo por delante.
  tl.to(panel.scale, { y: 0.0001, duration: b(0.34), ease: E.vaiven(3) }, b(3.55))
  tl.to(filoPanel.position, { y: -6.4, duration: b(0.34), ease: E.vaiven(3) }, b(3.55))
  tl.fromTo(barrido.position, { x: -5.0 }, { x: 5.0, duration: b(0.32), ease: E.vaiven(2) }, b(3.62))
