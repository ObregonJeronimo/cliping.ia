...
export default {
  ...
  mobiliario: { fondo: 'puntos', fondos: ['puntos', 'contorno', 'malla', 'recuento', 'costura'], marco: 'rotulado', marcos: ['rotulado', 'cantoneras', 'reglas', 'trazo'], hud: false, fondoForma: 0.90 },   // el margen asimetrico de un cuaderno: rompe la simetria del cuadro
