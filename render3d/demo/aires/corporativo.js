...
export default {
  ...
  mobiliario: { fondo: 'circuito', fondos: ['circuito', 'fuga', 'puntos', 'recuento', 'engranaje'], marco: 'reglas', marcos: ['reglas', 'escuadras', 'escalimetro', 'zocalo'], hud: true, fondoForma: 0.65 },   // la caja de un informe impreso, abierta a los lados
