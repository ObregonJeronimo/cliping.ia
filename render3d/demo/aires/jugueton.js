...
export default {
  ...
  mobiliario: { fondo: 'bloques', fondos: ['bloques', 'puntos', 'terrazo'], marco: 'nada', hud: false, fondoForma: 0.80, fondoCentro: [0.5, 0.5] },   // el color y la forma ya gritan; un marco encima es ruido
