...
export default {
  ...
  // HALACION: el halo naranja del fuego. En una pieza de comida el calor no es una metafora.
  pelicula: { bloom: 0.46, umbral: 0.76, radio: 0.55, grano: 0.078, vinieta: 0.95, aberr: 0.0015, vinietaForma: 0.15, vinietaCentro: [0.5, 0.55], halacion: { color: '#ff7a1e', fuerza: 0.7 } },
