...
export default {
  ...
  mobiliario: { fondo: 'rayas', fondos: ['rayas', 'destellos', 'fuga', 'haces', 'estelas', 'celosia'], marco: 'passepartout', marcos: ['passepartout', 'escuadras', 'ticks', 'cruces'], hud: false, fondoForma: 0.0, fondoCentro: [0.5, 0.68] },   // la masa oscura alrededor hace que el neon del centro se lea como neon
