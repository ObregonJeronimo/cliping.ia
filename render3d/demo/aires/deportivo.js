...
export default {
  ...
  mobiliario: { fondo: 'rayas', fondos: ['rayas', 'panal', 'bloques', 'estelas', 'latido', 'engranaje'], marco: 'ticks', marcos: ['ticks', 'escalimetro', 'escuadras', 'cruces'], hud: false, fondoForma: 0.45, fondoCentro: [0.5, 0.48] },   // acotacion: marca de pista, de cronometro, de medicion
  ...
  transiciones: ['flash', 'golpe', 'empuje', 'flash', 'corte', 'empujeV', 'tajo', 'atraviesa'],
