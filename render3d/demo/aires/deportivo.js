...
export default {
  ...
  mobiliario: { fondo: 'rayas', fondos: ['rayas', 'panal', 'bloques', 'estelas', 'latido'], marco: 'ticks', marcos: ['ticks', 'escalimetro', 'escuadras'], hud: false, fondoForma: 0.45, fondoCentro: [0.5, 0.48] },   // acotacion: marca de pista, de cronometro, de medicion
