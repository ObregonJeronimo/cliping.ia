...
if (typeof document !== 'undefined' && document.fonts && typeof FontFace === 'function') {
  await Promise.all(['Caprasimo-400', 'Caveat-600', 'Caveat-700', 'Fraunces-600', 'Fraunces-900', 'HankenGrotesk-400', 'Newsreader-400', 'PermanentMarker-400'].map(async nombre => {
...
export default {
  ...
  mobiliario: { fondo: 'contorno', fondos: ['contorno', 'terrazo', 'malla'], marco: 'reglas', marcos: ['reglas', 'cantoneras', 'nada'], hud: false, fondoForma: 0.50, fondoCentro: [0.42, 0.62] },   // papel: el filete de arriba y abajo de una pagina compuesta a mano
