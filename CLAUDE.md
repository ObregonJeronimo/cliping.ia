...
- **5 rápidas (~7 s), en cada cambio del motor:** `verificar.mjs`, `guion-check`, `encuadre-check`,
  `adn-check`, `testimonios-check`.
- **Guard completo (~30 min), sólo antes de pushear:** `npm run gates:guard`. Tiene que dar 28 OK /
